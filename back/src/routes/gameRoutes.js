 ...
 * post:
 * summary: 게임 시작 (HTTP 요청)
 * description: 방장이 게임을 시작할 때 DB 상태를 'playing'으로 변경하는 HTTP 요청. (웹소켓 연결 전 사용)
 * tags: [Game]
 * security:
 * - bearerAuth: []
 * parameters:
 ...
 * example: true
 */
router.post('/dr-mundo/game/room/start/:rNo', authMiddleware, gameCtrl.startGame); // ⬅️ **새로 추가된 라우트**
